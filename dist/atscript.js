...
class Interpreter {
    ...
    visitTemplateExpr(expr) {
        const result = expr.value.replace(/\$\{(.+?)\}/g, (m, placeholder) => this.templateParse(placeholder + ';'));
