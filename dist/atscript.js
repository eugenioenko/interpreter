    ...
    call(interpreter, thiz, args) {
        ...
        try {
            ...
            if (e instanceof _return__WEBPACK_IMPORTED_MODULE_1__["Return"]) {
                if (currentScope) {
                    interpreter.scope = currentScope;
                }
                return e.value;
            }
