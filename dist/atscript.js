...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "stringToUpperCase", function() { return stringToUpperCase; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "stringToLowercase", function() { return stringToLowercase; });
...
function stringToUpperCase(that) {
    const func = new _entity__WEBPACK_IMPORTED_MODULE_1__["InternalEntity"]();
    func.toString = () => '<internal function>';
    func.arity = () => 0;
    func.call = (int, thiz, args) => new _string__WEBPACK_IMPORTED_MODULE_3__["StringEntity"](thiz.value.toUpperCase());
    return func;
}
function stringToLowercase(that) {
    const func = new _entity__WEBPACK_IMPORTED_MODULE_1__["InternalEntity"]();
    func.toString = () => '<internal function>';
    func.arity = () => 0;
    func.call = (int, thiz, args) => new _string__WEBPACK_IMPORTED_MODULE_3__["StringEntity"](thiz.value.toLowerCase());
    return func;
}
...
class StringEntity extends _entity__WEBPACK_IMPORTED_MODULE_1__["PrototypeEntity"] {
    constructor(value) {
        ...
        this.prototype.values.set('toUpperCase', _runtime__WEBPACK_IMPORTED_MODULE_2__["stringToUpperCase"](this));
        this.prototype.values.set('toLowerCase', _runtime__WEBPACK_IMPORTED_MODULE_2__["stringToLowercase"](this));
    }
    get(key) {
        if (typeof key === 'number') {
